...
namespace App\Translator\Fuzzy;
 ...
 */
class FuzzyMatchingMessageCatalogue implements MessageCatalogueInterface, MetadataAwareInterface, CatalogueMetadataAwareInterface
{
    ...
    public function defines(string $id, string $domain = 'messages'): bool
    {
        ...
        if (isset($this->messages[$domain]) && $this->getFuzzyMatch($id, $this->messages[$domain])) {
            return true;
        }
    ...
    public function get(string $id, string $domain = 'messages'): string
    {
        ...
        if (array_key_exists($domain, $this->messages)) {
            $fuzzy = $this->getFuzzyMatch($id, $this->messages[$domain]);
            if ($fuzzy) {
                return $fuzzy;
            }
        }
    ...
    public static function getFuzzyMatch(string $id, array $messages): ?string
    {
        ...
        foreach ($wildcardMessages as $wildcard => $value) {
    ...
    {
        $altDomain = str_ends_with($domain, self::INTL_DOMAIN_SUFFIX) ? substr(
            $domain,
            0,
            -\strlen(self::INTL_DOMAIN_SUFFIX)
