...
use App\Translator\Fuzzy\FuzzyMatchingMessageCatalogue as MessageCatalogue;
 ...
 */
class FuzzyMatchingTranslator implements TranslatorInterface, TranslatorBagInterface, LocaleAwareInterface
{
    /**
